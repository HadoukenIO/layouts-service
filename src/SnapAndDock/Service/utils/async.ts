...
export function p<A0, T>(fn: (a: A0, s: FinCb<T>, f: FinErrCb) => void): (a: A0) => Promise<T>;
export function p<A0, A1, T>(fn: (a: A0, a1: A1, s: FinCb<T>, f: FinErrCb) => void): (a: A0, a1: A1) => Promise<T>;

export function p<A0, A1, A2, T>(fn: (a: A0, a1: A1, a2: A2, s: FinCb<T>, f: FinErrCb) => void): (a: A0, a1: A1, a2: A2) => Promise<T>;
export function p<A0, A1, A2, A3, T>(fn: (a: A0, a1: A1, a2: A2, a3: A3, s: FinCb<T>, f: FinErrCb) => void): (a: A0, a1: A1, a2: A2, a3: A3) => Promise<T>;

// tslint:disable-next-line:no-any
export function p<T>(fn: (...args: any[]) => any) {
    // tslint:disable-next-line:no-any
    return (...args: any[]): Promise<T> => new Promise((resolve, reject) => fn(...args, resolve, reject));
}
