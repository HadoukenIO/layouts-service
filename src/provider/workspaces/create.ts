...
import {addToWindowObject, adjustSizeOfFormerlyTabbedWindows, inWindowObject, parseVersionString, wasCreatedFromManifest, canRestoreProgrammatically, WindowObject} from './utils';
