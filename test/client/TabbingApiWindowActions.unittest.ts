...
import {TabAPIMessage} from '../../src/client/main';
...
declare namespace fin.desktop {
    let InterApplicationBus: {send: (name: string, uuid: string, message: any) => void;};
}
...
describe('Tests for tabbing api window actions', () => {
    describe('Tests for maximizing the window', () => {
        describe('A call to maximize', () => {
            it('should call fin.desktop.InterApplicationBus.send', () => {
                // Arrange
                const expectedPayload: TabAPIMessage = {action: TabAPIWindowActions.MAXIMIZE};
    ...
    describe('Tests for minimizing a window', () => {
        it('should call fin.desktop.InterApplicationBus.send', () => {
            // Arrange
            const expectedPayload: TabAPIMessage = {action: TabAPIWindowActions.MINIMIZE};
            const tabbingApiWindowActions: TabbingApiWindowActions = new TabbingApiWindowActions();
            jest.spyOn(fin.desktop.InterApplicationBus, 'send');
    ...
    describe('Tests for restoring a window', () => {
        it('should call fin.desktop.InterApplicationBus.send', () => {
            // Arrange
            const expectedPayload: TabAPIMessage = {action: TabAPIWindowActions.RESTORE};
            const tabbingApiWindowActions: TabbingApiWindowActions = new TabbingApiWindowActions();
            jest.spyOn(fin.desktop.InterApplicationBus, 'send');
    ...
    describe('Tests for closing a window', () => {
        it('should call fin.desktop.InterApplicationBus.send', () => {
            // Arrange
            const expectedPayload: TabAPIMessage = {action: TabAPIWindowActions.CLOSE};
            const tabbingApiWindowActions: TabbingApiWindowActions = new TabbingApiWindowActions();
            jest.spyOn(fin.desktop.InterApplicationBus, 'send');
    ...
    describe('Tests for toggling maximize', () => {
        it('should call fin.desktop.InterApplicationBus.send', () => {
            // Arrange
            const expectedPayload: TabAPIMessage = {action: TabAPIWindowActions.TOGGLEMAXIMIZE};
            const tabbingApiWindowActions: TabbingApiWindowActions = new TabbingApiWindowActions();
            jest.spyOn(fin.desktop.InterApplicationBus, 'send');
