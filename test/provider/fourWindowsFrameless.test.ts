...
test('inner horizontal resize', async t => {
  ...
  const firstRowExpectedWidth = (win1Bounds.right - win1Bounds.left) +
      (win2Bounds.right - win2Bounds.left);
  const secondRowExpectedWidth = (win3Bounds.right - win3Bounds.left) +
      (win4Bounds.right - win4Bounds.left);

  robot.moveMouse(win1Bounds.right, (win1Bounds.top + win1Bounds.bottom) / 2);
  robot.mouseToggle('down');
  robot.moveMouseSmooth(
      win1Bounds.right + 50, (win1Bounds.top + win1Bounds.bottom) / 2);
  ...
  const firstRowActualWidth = (win1Bounds.right - win1Bounds.left) +
      (win2Bounds.right - win2Bounds.left);
  const secondRowActualWidth = (win3Bounds.right - win3Bounds.left) +
      (win4Bounds.right - win4Bounds.left);
...
test('inner vertical resize', async t => {
  ...
  const firstColumnExpectedHeight = (win1Bounds.bottom - win1Bounds.top) +
      (win3Bounds.bottom - win3Bounds.top);
  const secondColumnExpectedHeight = (win2Bounds.bottom - win2Bounds.top) +
      (win4Bounds.bottom - win4Bounds.top);

  robot.moveMouse((win1Bounds.left + win1Bounds.right) / 2, win1Bounds.bottom);
  robot.mouseToggle('down');
  robot.moveMouseSmooth(
      (win1Bounds.left + win1Bounds.right) / 2, win1Bounds.bottom + 20);
  robot.mouseToggle('up');
  ...
  const firstColumnActualHeight = (win1Bounds.bottom - win1Bounds.top) +
      (win3Bounds.bottom - win3Bounds.top);
  const secondColumnActualHeight = (win2Bounds.bottom - win2Bounds.top) +
      (win4Bounds.bottom - win4Bounds.top);
...
test('outer vertical resize', async t => {
  ...
  robot.moveMouse(
      (win3Bounds.left + win3Bounds.right) / 2, win3Bounds.bottom - 1);
  robot.mouseToggle('down');
  robot.moveMouseSmooth(
      (win3Bounds.left + win3Bounds.right) / 2, win3Bounds.bottom + diff);
  robot.mouseToggle('up');
  ...
  const heights = [win1Bounds, win2Bounds, win3Bounds, win4Bounds].map(
...
test('outer horizontal resize', async t => {
  ...
  robot.moveMouse(
      win2Bounds.right - 1, (win2Bounds.top + win2Bounds.bottom) / 2);
  robot.mouseToggle('down');
  robot.moveMouseSmooth(
      win2Bounds.right + diff, (win2Bounds.top + win2Bounds.bottom) / 2);
  robot.mouseToggle('up');
  ...
  const widths = [win1Bounds, win2Bounds, win3Bounds, win4Bounds].map(
...
test('inner diagonal resize', async t => {
  ...
  const expectedWidths = [
    width(win1Bounds) - xDiff, width(win2Bounds) + xDiff,
    width(win3Bounds) - xDiff, width(win4Bounds) + xDiff
  ];
  const expectedHeights = [
    height(win1Bounds) - yDiff, height(win2Bounds) - yDiff,
    height(win3Bounds) + yDiff, height(win4Bounds) + yDiff
  ];
  ...
  robot.mouseToggle('down');
  robot.moveMouseSmooth(
      win1Bounds.right - 2 - xDiff, win1Bounds.bottom - 2 - yDiff);
  robot.mouseToggle('up');
...
test('group moving', async t => {
  ...
  const diff = 100;
  const expectedLeftCoords = [
    win1Bounds, win2Bounds, win3Bounds, win4Bounds
  ].map(bounds => bounds.left + diff);
  const expectedTopCoords = [
    win1Bounds, win2Bounds, win3Bounds, win4Bounds
  ].map(bounds => bounds.top + diff);
  ...
  const actualLeftCoords = [win1Bounds, win2Bounds, win3Bounds, win4Bounds].map(
      bounds => bounds.left);
  const actualTopCoords = [win1Bounds, win2Bounds, win3Bounds, win4Bounds].map(
      bounds => bounds.top);
