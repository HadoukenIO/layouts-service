...
import { Side, perpendicular } from './SideUtils';
...
export const dragCornerToCorner = async (draggedWindow: Win, draggedCorner: Corner, targetWindow: Win, targetCorner: Corner, offset?: Point) => {
...
export const dragSideToSide = async (draggedWindow: Win, draggedSide: Side, targetWindow: Win, targetSide: Side, offset?: Point) => {
    ...
    await dragCornerToCorner(draggedWindow, draggedCorner, targetWindow, targetCorner, (offset? offset : undefined));
};